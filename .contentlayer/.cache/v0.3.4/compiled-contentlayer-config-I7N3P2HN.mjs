...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      title: "musabbirsagar.com",
      author: "Musabbir Sagar",
      headerTitle: "Musabbirs Terminal",
      description: "A web development polymath and digital nomad who loves to create stunning websites with cutting-edge technologies",
      language: "en-us",
      theme: "system",
      // system, dark or light
      siteUrl: "https://musabbirsagar.com",
      siteRepo: "https://github.com/sagarmusabbir",
...
//# sourceMappingURL=compiled-contentlayer-config-I7N3P2HN.mjs.map
